  ...
  return (
    <div className="row mx-0 login-page">
      ...
      <div className="col-lg-6 right-section d-flex flex-column justify-content-center">
        ...
        <p className="right-section-info">Enter details to login.</p>
        <form className="col-12" onSubmit={handleSubmit}>
          ...
          <div className="password-input-container mt-4">
            <input
              type={inputType}
              placeholder="Password"
              className="password-input col-12"
              value={password}
              onChange={handlePasswordChange}
            />
            <button
            ...
            {passwordError && <p className="mt-2 error-msg">{passwordError}</p>}
          <div className="mt-4">
            <Link to="/forgot-password" className="col-12 forgot-password-text">
              FORGOT PASSWORD?
            </Link>
          </div>
          <button className="col-12 login-btn" disabled={!isFormValid}>
            LOG IN
          </button>
        </form>
      </div>
